...
var chemicalElements = [
    { link: 'https://bubble.immanuel.co/', symbol: 'ferris-theme/images/buble_.webp', name: 'Bubble Chat', group: 16, period: 3 },
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 17, period: 3 },
    { link: 'https://feedback.immanuel.co/', symbol: 'ferris-theme/images/yt_feed.png', name: 'Feedback', group: 18, period: 3 },
    { link: 'https://photos.immanuel.co/', symbol: 'ferris-theme/images/a7_.png', name: 'A7 Gallery', group: 1, period: 4 },
    { link: 'https://geoip.immanuel.co/', symbol: 'ferris-theme/images/geoip_.png', name: 'Geoip', group: 2, period: 4 },
    { link: 'https://gospel.immanuel.co/', symbol: 'ferris-theme/images/gospel_.png', name: 'Gospel', group: 3, period: 4 },
    { link: 'https://hi5.immanuel.co/Common/ScriptView', symbol: 'ferris-theme/images/hi5_.png', name: 'hi5 js', group: 4, period: 4 },
    { link: 'https://pdf.immanuel.co/Home/pdf', symbol: 'ferris-theme/images/htm_pdf.png', name: 'Html2Pdf', group: 5, period: 4 },
    { link: 'https://physics-2d-js.immanuel.co/matter10.html', symbol: 'ferris-theme/images/matter_.png', name: 'Matter Js', group: 6, period: 4 },
    { link: 'https://socket.immanuel.co/', symbol: 'ferris-theme/images/socket_.png', name: 'Socket', group: 7, period: 4 },
    ...
    { link: 'https://video-converter.immanuel.co/', symbol: 'ferris-theme/images/vid_cvrt.png', name: 'Video', group: 10, period: 4 },
    { link: 'https://ydl.immanuel.co/', symbol: 'ferris-theme/images/ydl_.png', name: 'Youtube', group: 11, period: 4 },
    { link: 'https://vulgarity-validator.immanuel.co/', symbol: 'ferris-theme/images/vulgr_.png', name: 'Vulgar', group: 12, period: 4 },
    { link: 'https://xsfood.org/webrtc/index.html', symbol: 'ferris-theme/images/webrtc_.png', name: 'Screen Share', group: 13, period: 4 },
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 14, period: 4 },
    ...
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 11, period: 5 },
    ...
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 8, period: 9 },
    ...
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 9, period: 6 },
    ...
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 6, period: 10 },
    ...
    { link: 'https://d3.immanuel.co/first.html', symbol: 'ferris-theme/images/d3js_.png', name: 'd3 js', group: 7, period: 7 },
