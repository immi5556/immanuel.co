...
var tt = document.getElementById("sling");
var slsh = document.getElementById("slsh");
slsh.onclick = function () {
    tt.style.display = tt.style.display === 'none' ? 'flex' : 'none';
    if (tt.style.display === 'flex') {
        var tu = document.querySelector("#sling canvas");
        if (tu) {
            tt.removeChild(tu)
        }
        Example.slingshot();
