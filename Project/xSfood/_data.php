...
function insertFoodFill($fdata, $response){
    ...
    $sql = "INSERT INTO xsFoofFill (MobileNo, FoodInfo, Address, Lat, Lng, FoodType, FoodStyle, availabletill) VALUES('".$fdata['telno']."','". $fdata['food'] ."','".$fdata['addr']."',".$fdata['pos']['lat']."," .$fdata['pos']['lng'].",'".$fdata['foodtype']."','".$fdata['foodstyle']."','".$availdate."');";
    //$sql = "select * from XsFoofFill";
...
function insertFoodFind($fdata, $response){
    $con = mysqli_connect(HOST,USER,PASS,DB) or die('Unable to Connect...');
    $availdate = date('Y-m-d H:i:s', strtotime($fdata['availabletill']));
    $sql = "INSERT INTO xsFoodFind (MobileNo, FoodInfo, Address, Lat, Lng, FoodType, FoodStyle, ExpectedTill) VALUES('".$fdata['telno']."','". $fdata['food'] ."','".$fdata['addr']."',".$fdata['pos']['lat']."," .$fdata['pos']['lng'].",'".$fdata['foodtype']."','".$fdata['foodstyle']."','".$availdate."');";
    //$sql = "select * from XsFoofFill";
    if (mysqli_query($con, $sql)) {
