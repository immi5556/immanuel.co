...
var soundObj = {
    ...
    abi_bday: ["sine", 440, 4, 523.25, .3, 523.25, .6, 293.66, .9, 523.25, 1.4, 349.23, 2, 329.63, 3]
}
...
function playSound(waveType, startFreq, endTime) {
    if (soundObj[arguments[0]] && arguments.length === 1) {
        ...
        for (var i = 3; i < arguments.length; i += 2) {
            console.log('args - ', arguments[i], arguments[i + 1])
        ...
        console.log('stops at', context.currentTime + endTime)
